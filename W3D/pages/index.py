...
def index() -> rx.Component:
    return rx.flex(
       ...
       rx.divider(),
       rx.text("""Worcester 3D Robotics offers 3D printer repair services in
       ...
       rx.card(rx.heading("Let’s get your project going. ", rx.link("Schedule a consultation",href="start"), size ="4"), bg='accent',color='accent'),
       spacing = "5",
       direction = "column",
    )

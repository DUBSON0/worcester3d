...
def start() -> rx.Component:
    return rx.vstack(
        ...
        rx.section(
            ...
            rx.text("""Book a 20 minute on-boarding consulation to get started. We will discuss the issue
                    your printer is having and what steps we can take to resolve it."""),
        size = "1"),
        rx.section(
            rx.heading("2. Prognosis", size = "4"),
            rx.text("""After on-boarding our team will compile a list of the possible root causes and the procedures
                    required to fix each of them."""),
        size = "1"),
        rx.section(
            rx.heading("3. Repair", size = "4"),
            rx.text("""You can choose to ship or drop off your printer at our location at your cost and
                    we'll repair it for a flat fee."""),
        size = "1"),
        rx.section(
        rx.spacer(direction="column"),
        rx.link(rx.button("Book Now", size="3"),href = "https://calendly.com/worcesterrobotics/30min"),
            size="1"), size="1"),
        rx.divider(),
        rx.section(
        rx.section(
            rx.heading("Pricing", size="3"),
            rx.text("""The on-boarding consulation fee is $35. After consulation we will provide a quote
                    for a flat repair fee. For standard printers the repair fee is typically
                    between $65-$125 including the part costs."""),
        size = "1"),
        rx.section(
            rx.heading("Our Guarantee", size = "3"),
            rx.text("""We are confident we can repair your printer, we can't guarantee it. In the
